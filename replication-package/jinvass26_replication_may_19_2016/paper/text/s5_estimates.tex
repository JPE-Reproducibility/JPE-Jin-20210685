...
Furthermore, the model replicates choice shares and selection patterns across major product-menu changes, including the introduction of the monitoring program and a change in the mandatory minimum coverage requirement in the focal state from \$40,000 to \$50,000.
