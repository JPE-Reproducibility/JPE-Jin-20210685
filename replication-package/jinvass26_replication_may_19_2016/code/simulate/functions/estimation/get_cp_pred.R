...
if(is.matrix(theta_1_log_score_mean)){
  # Match the Stan model (model_main.stan: X_R_tm[i,2] = llambda_clm - leps_n_clm)
  # and the CTF-facing path (get_d_latentparams.R:241): the second column is the
  # BASELINE log-rate excluding leps. Bug fix: previously this used llambda_clm
  # directly, which double-counted leps and produced wrong-sign Fig B.3 slopes.
