...
STATE              <- "IL"      # State identifier (Illinois)
...
if (!USE_SIMULATED_DATA) {
  ...
  # Rounded to 3 decimals; used as fixed data in model_main (not re-estimated)
  ...
  ## CTF market calibration (Illinois) — sourced from data profile
