...
if(recompile){
  ...
  out_model = cmdstanr::cmdstan_model(model_expose_function_path, force_recompile=T)
...
if(recompile){
  ctf_model = cmdstanr::cmdstan_model("code/simulate/functions/estimation/ctf_functions.stan", force_recompile=T)
